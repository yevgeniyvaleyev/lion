  ...
  <Story name="Default">
    {html`
      <lion-select-rich name="favoriteColor" label="Favorite color">
        ...
        <lion-option value="hotpink" checked>Hotpink</lion-option>
...
<Preview>
  <Story name="Options with HTML">
    {html`
      <lion-select-rich label="Favorite color" name="color" .modelValue="${'hotpink'}">
        <lion-option value="red">
          <p style="color: red;">I am red</p>
          <p>and multi Line</p>
        </lion-option>
        <lion-option value="hotpink">
          <p style="color: hotpink;">I am hotpink</p>
          <p>and multi Line</p>
        </lion-option>
        <lion-option value=teal>
