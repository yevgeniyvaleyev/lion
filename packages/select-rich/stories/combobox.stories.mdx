...
<Preview>
  <Story name="GoogleSearch">
    {html`
      <google-combobox name="combo" label="Google Search">
        <google-option value="Apple">Apple</google-option>
        <google-option value="Artichoke">Artichoke</google-option>
        <google-option value="Asparagus">Asparagus</google-option>
        <google-option value="Banana">Banana</google-option>
        <google-option value="Beets">Beets</google-option>
      </google-combobox>
    `}
  </Story>
</Preview>
