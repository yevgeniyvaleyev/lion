...
Use `autocomplete="list"` to automatically suggest the closest matching option in the text box.
By default `autocomplete="both"` is applied, which also activates the closest matching option as
active descendant.
